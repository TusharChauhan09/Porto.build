...
export default function Portfolio2Form({ initialData, onChange }: Portfolio2FormProps) {
    ...
    <div className="space-y-8 p-4">
      ...
      <fieldset className="space-y-3">
        ...
        <label className="block">
          ...
          <input
            ...
            className="mt-1 w-full rounded border border-input bg-background px-3 py-2 text-sm"
            placeholder="System Architect | Full Stack"
          />
        </label>
      ...
      <fieldset className="space-y-3">
        ...
        <p className="text-xs text-muted-foreground">
          Group skills by category (e.g. &quot;Backend Systems&quot;, &quot;Interface Design&quot;). Skills with the same category will be grouped together.
        </p>
        ...
        {data.education.map((edu, i) => (
          <div key={i} className="space-y-2 rounded border border-input p-3">
            ...
            <textarea
              ...
              rows={2}
              className="w-full rounded border border-input bg-background px-3 py-2 text-sm"
              placeholder="Description / honors (optional)"
            />
