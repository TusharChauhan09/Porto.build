...
export default function Portfolio8Form({ initialData, onChange }: Portfolio8FormProps) {
  ...
  return (
    <div className="space-y-8 p-4">
      ...
      <fieldset className="space-y-3">
        ...
        <label className="block">
          ...
          <textarea
            ...
            rows={3}
            className="mt-1 w-full rounded border border-input bg-background px-3 py-2 text-sm"
            placeholder="Passionate developer focused on building high-performance web applications..."
          />
        </label>
      ...
      <fieldset className="space-y-3">
        ...
        <p className="text-xs text-muted-foreground">Skills cycle through 3 visual styles: filled dark, primary purple, and outline border.</p>
      ...
      <fieldset className="space-y-4">
        ...
        <p className="text-xs text-muted-foreground">Project images display with grayscale-to-color on hover. Tags render as purple pills.</p>
        {data.projects.map((proj, i) => (
          <div key={i} className="space-y-2 rounded border border-input p-3">
            ...
            <input
              ...
              className="w-full rounded border border-input bg-background px-3 py-2 text-sm"
              placeholder="Tags (comma separated): Next.js, Three.js, WebGL..."
            />
            <input
              type="text"
              value={proj.image ?? ""}
      ...
      <fieldset className="space-y-4">
        ...
        <p className="text-xs text-muted-foreground">Displayed as a vertical timeline with expanding dot indicators on hover.</p>
      ...
      <fieldset className="space-y-4">
        ...
        <p className="text-xs text-muted-foreground">Degree abbreviation is auto-generated from the degree name (e.g. BSc → BS).</p>
      ...
      <fieldset className="space-y-4">
        ...
        <p className="text-xs text-muted-foreground">Cards invert to purple on hover with a large background number.</p>
