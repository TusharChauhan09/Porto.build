...
export default function Portfolio4Form({ initialData, onChange }: Portfolio4FormProps) {
  ...
  return (
    <div className="space-y-8 p-4">
      ...
      <fieldset className="space-y-3">
        ...
        <label className="block">
          ...
          <input
            ...
            className="mt-1 w-full rounded border border-input bg-background px-3 py-2 text-sm"
            placeholder="Sustainable Design Architect"
          />
        </label>
      ...
      <fieldset className="space-y-3">
        ...
        <p className="text-xs text-muted-foreground">Skills cycle through terracotta, sage, and gray pill styles.</p>
          ...
          <div key={i} className="space-y-2 rounded border border-input p-3">
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="w-28 flex-shrink-0 rounded border border-input bg-background px-3 py-2 text-sm"
      ...
      <fieldset className="space-y-4">
        ...
        <p className="text-xs text-muted-foreground">Project images are highly recommended for this template.</p>
        {data.projects.map((proj, i) => (
          <div key={i} className="space-y-2 rounded border border-input p-3">
            ...
            <input
              ...
              className="w-full rounded border border-input bg-background px-3 py-2 text-sm"
              placeholder="Tags (comma separated): Case Study, Mobile..."
            />
            <input
              type="text"
              value={proj.image ?? ""}
