...
export default function Portfolio3Form({ initialData, onChange }: Portfolio3FormProps) {
  ...
  return (
    <div className="space-y-8 p-4">
      ...
      <fieldset className="space-y-3">
        ...
        <p className="text-xs text-muted-foreground">The first skill is highlighted as primary in the template.</p>
          ...
          <div key={i} className="space-y-2 rounded border border-input p-3">
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 min-w-0 rounded border border-input bg-background px-3 py-2 text-sm"
                placeholder="User Research, Figma..."
              />
              <input
                type="text"
        ...
        {data.projects.map((proj, i) => (
          <div key={i} className="space-y-2 rounded border border-input p-3">
            ...
            <input
              ...
              className="w-full rounded border border-input bg-background px-3 py-2 text-sm"
              placeholder="Tags (comma separated): UX/UI, Accessibility..."
            />
            <input
              type="text"
              value={proj.image ?? ""}
              ...
              className="w-full rounded border border-input bg-background px-3 py-2 text-sm"
              placeholder="Project Image URL (recommended for this template)"
            />
