...
export default function Portfolio6Form({ initialData, onChange }: Portfolio6FormProps) {
  ...
  return (
    <div className="space-y-8 p-4">
      ...
      <fieldset className="space-y-3">
        ...
        <p className="text-xs text-muted-foreground">Group skills by category — each category becomes a card in the 4-column grid.</p>
      ...
      <fieldset className="space-y-4">
        ...
        <p className="text-xs text-muted-foreground">Project images display with a grayscale-to-color hover effect and brutalist border.</p>
        {data.projects.map((proj, i) => (
          <div key={i} className="space-y-2 rounded border border-input p-3">
            ...
            <input
              ...
              className="w-full rounded border border-input bg-background px-3 py-2 text-sm"
              placeholder="Tags (comma separated): React, WebGL, Three.js..."
            />
            <input
              type="text"
              value={proj.image ?? ""}
      ...
      <fieldset className="space-y-4">
        ...
        <p className="text-xs text-muted-foreground">Displayed as a vertical timeline with green dot indicators. First entry is highlighted.</p>
      ...
      <fieldset className="space-y-4">
        ...
        <p className="text-xs text-muted-foreground">Cards invert to neon green on hover for a bold brutalist effect.</p>
