...
export default function Portfolio7Form({ initialData, onChange }: Portfolio7FormProps) {
  ...
  return (
    <div className="space-y-8 p-4">
      ...
      <fieldset className="space-y-3">
        ...
        <label className="block">
          ...
          <input
            ...
            className="mt-1 w-full rounded border border-input bg-background px-3 py-2 text-sm"
            placeholder="Senior Interactive Developer"
          />
        </label>
        ...
        <label className="block">
          ...
          <textarea
            ...
            rows={3}
            className="mt-1 w-full rounded border border-input bg-background px-3 py-2 text-sm"
            placeholder="Defining the future of digital interaction through code and design..."
          />
        </label>
      ...
      <fieldset className="space-y-3">
        ...
        <p className="text-xs text-muted-foreground">Group skills by category — each category becomes a glassmorphic card. Skill names render as monospace pill tags.</p>
      ...
      <fieldset className="space-y-4">
        ...
        <p className="text-xs text-muted-foreground">Project images show a slide-up overlay on hover with title, description, and tags.</p>
        {data.projects.map((proj, i) => (
          <div key={i} className="space-y-2 rounded border border-input p-3">
            ...
            <input
              ...
              className="w-full rounded border border-input bg-background px-3 py-2 text-sm"
              placeholder="Tags (comma separated): WebGL, D3.js, Canvas..."
            />
            <input
              type="text"
              value={proj.image ?? ""}
      ...
      <fieldset className="space-y-4">
        ...
        <p className="text-xs text-muted-foreground">Displayed as a gradient timeline. First entry gets a glowing dot indicator.</p>
      ...
      <fieldset className="space-y-4">
        ...
        <p className="text-xs text-muted-foreground">Shown in the sticky sidebar alongside your profile.</p>
      ...
      <fieldset className="space-y-4">
        ...
        <p className="text-xs text-muted-foreground">Displayed as a 4-column grid of glassmorphic cards with hover lift effect.</p>
